...
<pre><code class="javascript">var orderedContinents = ['Asia', 'North America', 'Europe', 'South America', 'Africa', 'Australia']
...
Generally, I prefer changing the chart logic.  Since Chris's code
